...
// --- Icons ---
import { CornerDownLeftIcon } from "@/components/rich-text-editor/tiptap-icons/corner-down-left-icon";
import { ExternalLinkIcon } from "@/components/rich-text-editor/tiptap-icons/external-link-icon";
import { LinkIcon } from "@/components/rich-text-editor/tiptap-icons/link-icon";
import { TrashIcon } from "@/components/rich-text-editor/tiptap-icons/trash-icon";
// --- UI Primitives ---
import type { ButtonProps } from "@/components/rich-text-editor/tiptap-ui-primitive/button";
import {
  Button,
  ButtonGroup,
} from "@/components/rich-text-editor/tiptap-ui-primitive/button";
import {
  Card,
  CardBody,
  CardItemGroup,
...
import {
  Input,
  InputGroup,
} from "@/components/rich-text-editor/tiptap-ui-primitive/input";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
