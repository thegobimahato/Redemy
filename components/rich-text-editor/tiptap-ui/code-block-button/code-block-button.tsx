...
// --- Tiptap UI ---
import type { UseCodeBlockConfig } from "@/components/rich-text-editor/tiptap-ui/code-block-button";
import {
  CODE_BLOCK_SHORTCUT_KEY,
  useCodeBlock,
} from "@/components/rich-text-editor/tiptap-ui/code-block-button";
