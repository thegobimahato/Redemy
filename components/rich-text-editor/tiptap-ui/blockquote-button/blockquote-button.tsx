...
// --- Tiptap UI ---
import type { UseBlockquoteConfig } from "@/components/rich-text-editor/tiptap-ui/blockquote-button";
import {
  BLOCKQUOTE_SHORTCUT_KEY,
  useBlockquote,
} from "@/components/rich-text-editor/tiptap-ui/blockquote-button";
