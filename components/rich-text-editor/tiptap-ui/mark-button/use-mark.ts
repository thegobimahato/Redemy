...
import { Code2Icon } from "@/components/rich-text-editor/tiptap-icons/code2-icon"
import { ItalicIcon } from "@/components/rich-text-editor/tiptap-icons/italic-icon"
import { StrikeIcon } from "@/components/rich-text-editor/tiptap-icons/strike-icon"
import { SubscriptIcon } from "@/components/rich-text-editor/tiptap-icons/subscript-icon"
import { SuperscriptIcon } from "@/components/rich-text-editor/tiptap-icons/superscript-icon"
import { UnderlineIcon } from "@/components/rich-text-editor/tiptap-icons/underline-icon"
